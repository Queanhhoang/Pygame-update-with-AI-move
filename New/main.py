...
BLACK = (0, 0, 20)
# FONTS ***********************************************************************
font = pygame.font.SysFont('cursive', 42)
select_car = font.render('Select Character', True, WHITE)
# IMAGES **********************************************************************
...
for i in range(1, 9):
	...
	img = pygame.transform.scale(img, (79, 141))
	cars.append(img)
nitro_frames = []
nitro_counter = 0
for i in range(6):
...
# BUTTONS *********************************************************************
play_btn = Button(play_img, (120, 64), center(play_img)+190, HEIGHT-100)
